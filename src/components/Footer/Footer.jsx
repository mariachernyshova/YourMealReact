        ...
        <footer className="footer">
            <Container>
                <div className="footer__content">
                    <img className="footer__logo" src="../../assets/img/logo-o.svg" alt="Логотип YourMeal"/>

                    <address className="footer__address">
                        <div className="footer__contact">
                            <h2 className="footer__title">Номер для заказа</h2>

                            <a className="footer__phone" href="tel:+79308333811">
                        ...
                        <div className="footer__contact">
                            ...
                            <li className="footer__item">
                                <a href="#" className="footer__sn" aria-label="группа в вк">
                            ...
                            <li className="footer__item">
                                <a href="#" className="footer__sn" aria-label="канал в telegram">
                                <svg width="36" height="36" viewBox="0 0 36 36" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
